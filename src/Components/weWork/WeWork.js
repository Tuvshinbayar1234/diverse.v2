        ...
        <div className='w-full pt-10 pb-20 sm:pb-40'>
            <div className='container mx-auto hidden xl:block'>
                <div className='flex justify-between px-5 w-full space-x-10'>
                    ...
                    <span id='WeWork' class="relative w-128 h-80 pt-10 shadow-md">
                    ...
                    <span class="relative w-128 h-80 flex-col pt-10  mt-36  shadow-md " >
                        <h1 className=' text-4xl w-3/12 mx-10 font-bold' style={{ fontFamily: 'Magistral' }}>Decentralized Applications</h1>
                    ...
                    <span class="relative w-128 h-80 flex-col pt-10  shadow-md " >
                        <h1 className=' text-4xl w-3/12 mx-10 font-bold' style={{ fontFamily: 'Magistral' }}>Blockchain Consultation</h1>
